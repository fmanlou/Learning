...
HTTPD_MMN = 20120211
abs_srcdir = /home/fmanlou/Documents/httpd-2.4.46
...
SHELL = /bin/bash
RSYNC = /usr/bin/rsync
MODULE_DIRS = aaa cache core database debugging filters http ldap loggers metadata proxy session slotmem proxy/balancers arch/unix dav/main generators dav/fs mappers
MODULE_CLEANDIRS = arch/win32 echo examples experimental lua ssl test http2 md cluster dav/lock
PORT = 80
SSLPORT = 443
CORE_IMPLIB_FILE =
CORE_IMPLIB =
